...
function showResults() {
  ...
  document
    .getElementById("arc-correct")
    .setAttribute("stroke-dasharray", `${correctDash} ${CIRC}`);
  document
    .getElementById("arc-wrong")
    .setAttribute("stroke-dasharray", `${wrongDash} ${CIRC}`);
  document
    .getElementById("arc-wrong")
    .setAttribute("stroke-dashoffset", `-${correctDash}`);
...
function updateProgress() {
  ...
  document.getElementById("progLabel").textContent =
    `Вопрос ${questionsAnswered} из ${questionsLimit}`;
...
function answer(result) {
  ...
  document.getElementById("infoText").textContent = currentQuestion.info;
